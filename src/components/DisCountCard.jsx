...
const DisCountCard = ({title, subTitle, img}) => {
  return (
    <div className="slide">
      <img src={ellipse} className="absolute right-0" />
      <img src={Group} className="absolute  top-[115px] right-2" />
      <img src={Group} className="absolute  top-[95px] right-2" />
      <img src={Group} className="absolute  top-1/4 right-2" />
